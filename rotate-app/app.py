...
def create_rotate(path_file, original_filename):
    ...
    try:
        ...
        publish_notification(original_filename, 'rotacionado')
        logging.info(f"Imagem {original_filename} rotacionada e salva em {output_path}")
        ...
        while True:
            ...
            if msg is None:
                ...
                try:
                    ...
                    if filename:
                        logging.warning(f"ROTATE: Lendo {filename}")
                        create_rotate(os.path.join(IN_FOLDER, filename), filename)
                        logging.warning(f"ROTATE: Finalizado {filename}")
                    else:
